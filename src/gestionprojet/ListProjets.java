 ...
 * @author User
 */
public class ListProjets extends javax.swing.JFrame {
  Connection con;
    /**
     * Creates new form ListProjets
     */
     public ListProjets() {
        initComponents();
...
//    String sql="SELECT * FROM projets";
//try{
//DefaultTableModel rowCount =(DefaultTableModel)jTable1.getModel();
...
//System.out.println("Error:"+ex.getMessage());}}
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "projet_id", "project_name", "dateDebut", "dateFin", "membre", "etat", "projet_manager_id"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListProjets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListProjets().setVisible(true);
            }
        });
    }
